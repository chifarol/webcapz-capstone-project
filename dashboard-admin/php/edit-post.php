                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="mb-3">
                        ...
                        <form enctype="multipart/form-data" id="create-post-form" method="post"
                            action="functions/edit-post-handler.php">
                                ...
                                <div class="card mb-4">
                                    <div class="card-body demo-vertical-spacing demo-only-element">
                                        <span class="text-danger">
                                            <?php echo $_SESSION['edit_post_error_msg'] ?>
                                        </span>
                                        <div>
                                            ...
                                            <input form="create-post-form" type="text" class="form-control"
                                                ...
                                                value="<?php echo $postObj['post_title'] ?? '' ?>"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="form" enctype="multi-part/form-data"
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        <div class='form-check mt-3'>
                                                            <input class='form-check-input' type='radio'
                                                                value="<?php echo $row['id'] ?>" id='defaultCheck1'
                                                                name='category' form='create-post-form' <?php echo ($postObj['category_id'] == $row['id']) ? 'checked' : '' ?>>
